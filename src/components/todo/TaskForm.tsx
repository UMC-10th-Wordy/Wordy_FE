    ...
    <form className="flex w-full flex-col items-end gap-4 rounded-lg border border-(--color-border-brand-subtle) bg-(--color-bg-default) p-5 shadow-[0px_1px_5px_0px_rgba(0,0,0,0.1)]">
      ...
      <div className="flex w-full flex-wrap items-start gap-5">
        <div className="flex min-w-0 flex-1 flex-col items-start gap-2">
          ...
          <div className="flex shrink-0 items-center justify-center gap-1 rounded-lg bg-(--color-bg-tertiary) px-2 py-1">
      ...
      <div className="flex w-full flex-col items-start gap-2">
        ...
        <Input2 placeholder="업무명을 입력해 주세요" className="w-full" />
      </div>
      ...
      <div className="flex w-full flex-col items-start gap-2">
        ...
        <Input2 placeholder="업무와 관련한 내용을 자유롭게 적어주세요" className="w-full" />
      </div>
      ...
      <div className="flex shrink-0 items-start gap-3">
        ...
        <TextButton type="button" variant="fill" className="w-[140px]" disabled>
          업무 추가하기
        </TextButton>
      </div>
    </form>
