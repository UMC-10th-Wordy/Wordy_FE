...
export const INITIAL_ELIGIBILITY_MOCK: EligibilityDto = {
  ...
  weekEnd: '2026-08-21',
  entries: [
    { dailyEntryId: 'mock-entry-1', entryDate: '2026-08-15' },
    { dailyEntryId: 'mock-entry-2', entryDate: '2026-08-16' },
    { dailyEntryId: 'mock-entry-3', entryDate: '2026-08-17' },
    { dailyEntryId: 'mock-entry-4', entryDate: '2026-08-19' },
    { dailyEntryId: 'mock-entry-5', entryDate: '2026-08-20' },
  ],
}
...
export const INITIAL_MONTHLY_DASHBOARD_LIST_MOCK: DashboardListItemDto[] = [
  {
    dashboardId: 'mock-monthly-dashboard-1',
    startDate: '2026-08-01',
    endDate: '2026-08-31',
    summary: '이번 달은 제품 전략 정렬과 디자인 시스템 V2를 중심으로 움직였어요.',
  ...
  performances: [
    {
      ...
      items: [{ output: '2026년 8월 11일 업무 일지', impact: '합의안 도출 완료' }],
    },
    {
      achievementRate: 65,
      ...
      items: [{ output: '2026년 8월 13일 업무 일지', impact: '이탈 지점 교차 검증 완료' }],
    },
    {
      achievementRate: 65,
      ...
      items: [{ output: '2026년 8월 12일 업무 일지', impact: '사용자 테스트 일정 확정' }],
    },
  ],
}
